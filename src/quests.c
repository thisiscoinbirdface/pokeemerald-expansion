...
static const struct SubQuest sSubQuests5[QUEST_5_SUB_COUNT] =
{
	sub_quest(
		18,
		gText_SubQuest5_Name1,
		gText_SubQuest5_Desc1,
		gText_SideQuestMap1,
		OBJ_EVENT_GFX_WALLY,
		OBJECT,
		sText_Empty
	...
	sub_quest(
		19,
		gText_SubQuest5_Name2,
		gText_SubQuest5_Desc2,
		gText_SideQuestMap2,
		OBJ_EVENT_GFX_WALLY,
		OBJECT,
		sText_Empty
	...
	sub_quest(
		20,
		gText_SubQuest5_Name3,
		gText_SubQuest5_Desc3,
		gText_SideQuestMap3,
		OBJ_EVENT_GFX_WALLY,
		OBJECT,
		sText_Empty
...
static const struct SubQuest sSubQuests6[QUEST_6_SUB_COUNT] =
{
	sub_quest(
		21,
		gText_SubQuest6_Name1,
		gText_SubQuest6_Desc1,
		gText_SideQuestMap1,
		OBJ_EVENT_GFX_WALLY,
		OBJECT,
		sText_Empty
	...
	sub_quest(
		22,
		gText_SubQuest6_Name2,
		gText_SubQuest6_Desc2,
		gText_SideQuestMap2,
		OBJ_EVENT_GFX_WALLY,
		OBJECT,
		sText_Empty
	...
	sub_quest(
		23,
		gText_SubQuest6_Name3,
		gText_SubQuest6_Desc3,
		gText_SideQuestMap3,
		OBJ_EVENT_GFX_WALLY,
		OBJECT,
		sText_Empty
	...
	sub_quest(
		24,
		gText_SubQuest6_Name4,
		gText_SubQuest6_Desc4,
		gText_SideQuestMap3,
		OBJ_EVENT_GFX_WALLY,
		OBJECT,
		sText_Empty
...
{	
	FillWindowPixelBuffer(1, 0);
	//I've removed this line to remove the location text
...
static void QuestMenu_CreateSprite(u16 itemId, u8 idx, u8 spriteType)
{
	//I CHANGED COMMENTED ALL THIS OUT TO REMOVE THE SPRITE
	...
	// 	gSprites[0].oam.objMode = ST_OAM_OBJ_BLEND;
