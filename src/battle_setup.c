...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_NONE, TRAINER_NONE, TRAINER_NONE, TRAINER_NONE, TRAINER_NONE, ROUTE118),
};
...
u8 BattleSetup_GetTerrainId(void)
{
    ...
    if (MetatileBehavior_IsAshGrass(tileBehavior))
...
void PlayTrainerEncounterMusic(void)
{
        ...
        && TRAINER_BATTLE_PARAM.mode != TRAINER_BATTLE_CONTINUE_SCRIPT_DOUBLE_NO_MUSIC)
    {
        ...
        case TRAINER_ENCOUNTER_MUSIC_RICH:
            ...
            break;
        case TRAINER_ENCOUNTER_MUSIC_KOHLA:
            music = MUS_RG_TEACHY_TV_SHOW;
            break;
        case TRAINER_ENCOUNTER_MUSIC_FINAL:
            music = MUS_RG_TEACHY_TV_SHOW;
            break;            
        default:
