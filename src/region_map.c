...
//    [MAPSEC_ROUTE_1] = {MAP_GROUP(ROUTE_1), MAP_NUM(ROUTE_1), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
//    [MAPSEC_ROUTE_2] = {MAP_GROUP(ROUTE_1), MAP_NUM(ROUTE_1), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
