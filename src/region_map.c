...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_CERAM_BASE_CAMP] = {MAP_GROUP(MAPSEC_CERAM_BASE_CAMP), MAP_NUM(MAPSEC_CERAM_BASE_CAMP), HEAL_LOCATION_CERAM_BASE_CAMP},

    [MAPSEC_ROUTE1] = {MAP_GROUP(ROUTE1), MAP_NUM(ROUTE1), HEAL_LOCATION_CARABRUE_TOWN},
    [MAPSEC_ROUTE2] = {MAP_GROUP(ROUTE2), MAP_NUM(ROUTE2), HEAL_LOCATION_FENNILAHL_TOWN},
    [MAPSEC_ROUTE3] = {MAP_GROUP(ROUTE3), MAP_NUM(ROUTE3), HEAL_LOCATION_GASTREE_CITY},
    [MAPSEC_ROUTE4] = {MAP_GROUP(ROUTE4), MAP_NUM(ROUTE4), HEAL_LOCATION_GASTREE_CITY},
