...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_ROUTE1] = {MAP_GROUP(ROUTE_1), MAP_NUM(ROUTE_1), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
    [MAPSEC_ROUTE2] = {MAP_GROUP(ROUTE_1), MAP_NUM(ROUTE_1), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
