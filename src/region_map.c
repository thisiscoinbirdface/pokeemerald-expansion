...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_GALECREST_CITY] = {MAP_GROUP(GALECREST_CITY), MAP_NUM(GALECREST_CITY), HEAL_LOCATION_CERAM_BASE_CAMP},
    ...
    [MAPSEC_CHAMPIONSHIP] = {MAP_GROUP(CHAMPIONSHIP), MAP_NUM(CHAMPIONSHIP), HEAL_LOCATION_VICTORY_CAPE},
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_CARABRUE_TOWN; mapSecId <= MAPSEC_CHAMPIONSHIP; mapSecId++)
    {
