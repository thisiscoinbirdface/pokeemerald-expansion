const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_MUNUCU] = TRAINER_PIC_PSYCHIC_F,
    [FACILITY_CLASS_SHUBUBU] = TRAINER_PIC_POKEMON_BREEDER_F,
    [FACILITY_CLASS_GUBUKING] = TRAINER_PIC_LASS,
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_MUNUCU] = TRAINER_CLASS_RS_PROTAG,      //CHAR 1
    [FACILITY_CLASS_SHUBUBU] = TRAINER_CLASS_RS_PROTAG,     //CHAR 2
    [FACILITY_CLASS_GUBUKING] = TRAINER_CLASS_RS_PROTAG,    //CHAR 3
};
