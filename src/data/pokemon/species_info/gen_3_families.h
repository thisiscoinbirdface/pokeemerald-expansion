...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_LINOONE_GALAR] =
    {
        ...
        .formSpeciesIdTable = sLinooneFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_OBSTAGOON}),
    },
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_GALLADE_MEGA] =
    {
        ...
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_FIGHTING),
        .catchRate = 45,
        .expYield = 170, //(P_UPDATED_EXP_YIELDS >= GEN_8) ? 309 : 278,
        .evYield_Attack = 3,
        .genderRatio = MON_MALE,
        .eggCycles = 20,
        .friendship = 35,
    ...
    [SPECIES_ARON] =
    {
        ...
        .catchRate = 180,
        .expYield = 55,//(P_UPDATED_EXP_YIELDS >= GEN_5) ? 66 : 96,
        .evYield_Defense = 1,
    ...
    [SPECIES_LAIRON] =
    {
        ...
        .types = MON_TYPES(TYPE_STEEL, TYPE_ROCK),
        .catchRate = 90,
        .expYield = 90,//(P_UPDATED_EXP_YIELDS >= GEN_5) ? 151 : 152,
        .evYield_Defense = 2,
        .itemRare = ITEM_HARD_STONE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 35,
    ...
    [SPECIES_MEDITITE] =
    {
        ...
        .catchRate = 180,
        .expYield = 74, //(P_UPDATED_EXP_YIELDS >= GEN_5) ? 56 : 91,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_SWABLU] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
        .catchRate = 255,
        .expYield = 74,//(P_UPDATED_EXP_YIELDS >= GEN_5) ? 62 : 74,  
        .evYield_SpDefense = 1,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_SHUPPET] =
    {
        ...
        .catchRate = 225,
        .expYield = 62,//(P_UPDATED_EXP_YIELDS >= GEN_5) ? 59 : 97,
        .evYield_Attack = 1,
    ...
    [SPECIES_BANETTE] =
    {
        ...
        .types = MON_TYPES(TYPE_GHOST),
        .catchRate = 45,
        .expYield = 98,//(P_UPDATED_EXP_YIELDS >= GEN_5) ? 159 : 179,
        .evYield_Attack = 2,
        .itemRare = ITEM_SPELL_TAG,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 25,
