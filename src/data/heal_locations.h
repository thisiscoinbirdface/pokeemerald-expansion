static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_GASTREE_CITY - 1] = {MAP_GROUP(GASTREE_CITY), MAP_NUM(GASTREE_CITY), 18, 17},
    ...
    [HEAL_LOCATION_PELLUCA_CITY - 1] = {MAP_GROUP(PELLUCA_CITY), MAP_NUM(PELLUCA_CITY), 14, 14},
