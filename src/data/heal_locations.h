static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_GASTREE_CITY - 1] = {MAP_GROUP(GASTREE_CITY), MAP_NUM(GASTREE_CITY), 17, 17},
    ...
    [HEAL_LOCATION_VICTORY_CAPE - 1] = {MAP_GROUP(CHAMPIONSHIP), MAP_NUM(CHAMPIONSHIP), 40, 38},
