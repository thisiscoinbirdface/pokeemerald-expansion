static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_GASTREE_CITY - 1] = {MAP_GROUP(GASTREE_CITY), MAP_NUM(GASTREE_CITY), 18, 19},
    [HEAL_LOCATION_CERAM_BASE_CAMP - 1] = {MAP_GROUP(CERAM_BASE_CAMP), MAP_NUM(CERAM_BASE_CAMP), 21, 33},
};
