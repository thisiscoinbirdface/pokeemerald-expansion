static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_CARABRUE_TOWN - 1] = {MAP_GROUP(CARABRUE_TOWN), MAP_NUM(CARABRUE_TOWN), 7, 9},
    [HEAL_LOCATION_FENNILAHL_TOWN - 1] = {MAP_GROUP(FENNILAHL_TOWN), MAP_NUM(FENNILAHL_TOWN), 14, 16},
