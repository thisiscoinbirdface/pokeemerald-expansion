...
{
    FLAG_VISITED_FENNILAHL_TOWN,
    FLAG_VISITED_GASTREE_CITY,
    FLAG_VISITED_CERAM_BASE_CAMP,
    FLAG_VISITED_GALECREST_CITY,
    FLAG_VISITED_PELLUCA_CITY,
    FLAG_VISITED_MIRROH_BASE_CAMP,
    FLAG_VISITED_WINTERLILY_HOLLOW,
    FLAG_VISITED_RIVETSHORE_CITY,
    FLAG_VISITED_VICTORY_CAPE,
    FLAG_VISITED_SILVERSUN_CITY,
