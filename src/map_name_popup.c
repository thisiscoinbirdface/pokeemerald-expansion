...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_CARABRUE_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_FENNILAHL_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_GASTREE_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_CERAM_BASE_CAMP - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
