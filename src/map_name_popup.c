...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_GALECREST_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SILVERSUN_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_PELLUCA_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MIRROH_BASE_CAMP - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_WINTERLILY_HOLLOW - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,

    [MAPSEC_ROUTE1 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE2 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,   
    [MAPSEC_ROUTE3 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,  
    [MAPSEC_ROUTE4 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE5 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE6 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,

    [MAPSEC_VINE_CAVERNS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,   
    [MAPSEC_FENNILAHL_TUNNEL - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,           
    [MAPSEC_MT_CERAM - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,    
    [MAPSEC_VILETHORN_WOODS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,       
    [MAPSEC_MT_MIRROH_EXTERIOR - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,  
    [MAPSEC_MT_MIRROH_INTERIOR - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,         
    [MAPSEC_MIRROH_PEAK - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,    
    [MAPSEC_LILY_POND - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,    
};
