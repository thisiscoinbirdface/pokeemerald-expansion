...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_CARABRUE_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_FENNILAHL_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_GASTREE_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CERAM_BASE_CAMP - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_GALECREST_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SILVERSUN_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_PELLUCA_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MIRROH_BASE_CAMP - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_WINTERLILY_HOLLOW - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_RIVETSHORE_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,

    [MAPSEC_ROUTE1 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE2 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,   
    [MAPSEC_ROUTE3 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,  
    [MAPSEC_ROUTE3_UNDERPASS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,  
    [MAPSEC_ROUTE4 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE5 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE6 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE7 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE8 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,

    [MAPSEC_VINE_CAVERNS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,   
    [MAPSEC_FENNILAHL_TUNNEL - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,           
    [MAPSEC_MT_CERAM - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,    
    [MAPSEC_VILETHORN_WOODS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,       
    [MAPSEC_MT_MIRROH_EXTERIOR - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,  
    [MAPSEC_MT_MIRROH_INTERIOR - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,         
    [MAPSEC_MIRROH_PEAK - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,    
    [MAPSEC_LILY_POND - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,    
    [MAPSEC_SSELEGANT - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,

    [MAPSEC_RANGER_INSTITUTE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_RANGER_INSTITUTE_IVY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_RANGER_INSTITUTE_RIVETSHORE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
};
