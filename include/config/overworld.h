...
#define B_FLAG_FOLLOWERS_DISABLED      FLAG_SYS_OW_FOLLOWERS_DISABLED          // Enables / Disables followers by using a flag. Helpful to disable followers for a period of time.
...
#define OW_FLAG_NO_ENCOUNTER        FLAG_SYS_WILD_ENCOUNTERS  // If this flag is set, wild encounters will be disabled.
