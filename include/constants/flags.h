...
#define FLAG_VISITED_PELLUCA_CITY                   (SYSTEM_FLAGS + 0x13)
#define FLAG_VISITED_MIRROH_BASE_CAMP               (SYSTEM_FLAGS + 0x14)
#define FLAG_VISITED_WINTERLILY_HOLLOW              (SYSTEM_FLAGS + 0x15)
#define FLAG_VISITED_RIVETSHORE_CITY                (SYSTEM_FLAGS + 0x16)
#define FLAG_VISITED_VICTORY_CAPE                   (SYSTEM_FLAGS + 0x17)
#define FLAG_VISITED_SILVERSUN_CITY                 (SYSTEM_FLAGS + 0x18)
